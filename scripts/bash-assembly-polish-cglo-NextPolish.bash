...
#SBATCH --job-name=cglo-NextPolish				#Job name
...
#SBATCH --output=cglo-NP-out.log							#save stdout to file
#SBATCH --error=cglo-NP-err.log								#save stderr to file
...
# run NextDenovo
../../../../../../../software/NextPolish/nextPolish NextPolish.cfg